...
// Strings returns a DiffWriteable that diffs a and b.
func Strings(a, b []string) DiffWriteable {
...
func Slices(a, b interface{}, equal func(x, y interface{}) bool) DiffWriteable {
	if equal == nil {
